...
If running with --ext_master, and using the master sheet for merging and re-assembling, then provide either a --sample_sheet or --raw_dir in addition to the --ext_master sheet for running in --source default or umd, respectively.
